...
define( "HEADER", "ЧАТИК" ); //Заголовок

define( "COOKIEPATH", "/" );

define( "CHATTRIM", 0 ); //Максимальная длина пересылаемого куска чата, 0 - без ограничений

define( "MAXUSERNAMELEN", 12 ); //Максимальная длина имени пользователя
define( "MAXUSERTEXTLEN", 504 ); //Максимальная длина сообщения пользователя
